...
<header class="home-header site-header">
    <div class="home-container home-header-inner">
        <a href="{{ route('home') }}" class="home-brand" aria-label="Huellas en Casa, inicio">
            ...
            <span><span class="home-brand-name block">Huellas en Casa</span><span class="home-brand-description block">Portal de mascotas perdidas y encontradas</span></span>
        </a>
        <nav class="home-nav" aria-label="Navegación principal">
            ...
            <a href="{{ route('reportes-encontrados.index') }}" @if(request()->routeIs('reportes-encontrados.index')) aria-current="page" @endif>Mascotas encontradas</a>
